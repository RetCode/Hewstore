...
<body>
    <main class="main-block">
        <div class="left-menu">
            ...
            <div class="menu_links">
                <ul>
                    ...
                    <li>
                        <a class="pages_link active" href="">Фильтры</a>
                    </li>
                    <li>
                        <button class="add_item-button">Добавить фильтр</button>
                    </li>
                </ul>
            </div>
        </div>
        <div class="content-block">
            <div class="content open">
                <div class="nav-block filters">
                    <p>#</p>
                    <p>Название</p>
                    <p>Категория</p>
                    <p>Значение категории</p>
                    <p>Инструменты</p>
                </div>
            ...
            <div class="add_item-block">
                <div class="container">
                    <div class="add_item-header">
                        ...
                        <p class="title">Добавление нового фильтра</p>
                    </div>
    ...
    <script>
        ...
        function deleteData(object)
        {
            ...
            url: "/api",
            type: "POST",
            data: {method: 'deleteFilter', id: id},
                success: function(response) {
                    if(response["succes"] == true)
                    {
                        document.getElementById("alerts").innerHTML += `<div class="alert alert-success" role="alert">
        ...
        function savedata()
        {
            ...
            url: "/api",
            type: "POST",
            data: {method: 'editFilter', id: id, text: name},
                success: function(response) {
                    if(response["succes"] == true)
                    {
                        document.getElementById("alerts").innerHTML += `<div class="alert alert-success" role="alert">
