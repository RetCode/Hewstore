...
<body>
        ...
        <div class="left-menu">
            ...
            <div class="menu_links">
                <ul>
                    ...
                    <li>
                        <a class="pages_link active" href="">Тип товара</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <button class="add_item-button">Добавить тип товара</button>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="add_item-block">
                <div class="container">
                    ...
                    <div class="add_item-wrapper">
                        ...
                        <input class="add_item pl" type="text" placeholder="Цена">
    ...
    <script>
        ...
        function savedata()
        {
            ...
            url: "/api",
            type: "POST",
            data: {method: 'editProductType', id: id, text: name},
                success: function(response) {
                    if(response["succes"] == true)
                    {
                        document.getElementById("alerts").innerHTML += `<div class="alert alert-success" role="alert">
            ...
            success: function(response) {
                    response["items"].forEach(element => {
                        ...
                        <div class="item types">
                            <p>${element["id"]}</p>
                            <p>${element["productTitle"]}: ${element["name"]}</p>
                            <p>${element["cost"]}$</p>
